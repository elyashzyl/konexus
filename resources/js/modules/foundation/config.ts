...
export const FOUNDATION_MODULES: FoundationModule[] = [
    ...
    {
        key: 'class-schedules',
        path: '/school/class-schedules',
        title: 'Class Schedules',
        description: 'Weekly timetables built per section.',
        resource: 'class-schedules',
        singularLabel: 'class schedule',
        icon: CalendarClock,
        columns: [
        ...
        fields: [
            { name: 'academic_year_id', label: 'Academic year', type: 'select', optionsResource: 'academic-years', required: true },
            { name: 'grade_level_id', label: 'Grade level', type: 'select', optionsResource: 'grade-levels', required: true, disabledOnEdit: true },
            { name: 'section_id', label: 'Section', type: 'select', optionsResource: 'sections', required: true },
            { name: 'subject_id', label: 'Subject', type: 'select', optionsResource: 'subjects', required: true },
            { name: 'teacher_id', label: 'Teacher', type: 'select', optionsResource: 'teachers', required: true },
            { name: 'room_id', label: 'Room', type: 'select', optionsResource: 'rooms' },
            {
                name: 'day',
                label: 'Day',
