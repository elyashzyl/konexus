...
export const portalRoutes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'enrollments',
                name: 'portal.staff.registrar.enrollments',
                component: () => import('@/pages/portal/staff/EnrollmentData.vue'),
                meta: { title: 'Enrollment Data', breadcrumbs: [{ title: 'Staff Portal' }, { title: 'Enrollment Data' }] },
            },
            {
                path: 'enrollments/apply',
                name: 'portal.staff.registrar.enrollments.apply',
                component: () => import('@/pages/foundation/WalkInEnrollment.vue'),
                meta: {
                    title: 'New Walk-in Enrollment',
                    breadcrumbs: [{ title: 'Staff Portal' }, { title: 'Enrollment Data' }, { title: 'New Walk-in Enrollment' }],
                },
            },
            {
                path: 'students',
                name: 'portal.staff.registrar.students',
                component: () => import('@/pages/portal/staff/Students.vue'),
                meta: { title: 'Students', breadcrumbs: [{ title: 'Staff Portal' }, { title: 'Students' }] },
            },
            {
                path: 'notifications',
                name: 'portal.staff.registrar.notifications',
                component: () => import('@/pages/portal/staff/Notifications.vue'),
                meta: { title: 'Notification Center', breadcrumbs: [{ title: 'Staff Portal' }, { title: 'Notification Center' }] },
            },
            {
            ...
            },
            {
                ...
                name: 'portal.staff.principal.enrollment-approvals',
                component: () => import('@/pages/portal/staff/PrincipalEnrollmentApprovals.vue'),
                meta: { title: 'Enrollment Approvals', breadcrumbs: [{ title: 'Staff Portal' }, { title: 'Enrollment Approvals' }] },
            },
            {
                path: 'enrollment-payments',
                name: 'portal.staff.finance.enrollment-payments',
