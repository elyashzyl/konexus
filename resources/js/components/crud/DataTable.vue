...
<template>
    <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <Button v-if="store.trashed" variant="outline" class="gap-2" @click="toggleTrash">
                <RefreshCcw class="size-4" />
                Active records
            </Button>
            <Button v-else variant="outline" class="gap-2" @click="toggleTrash">
                <Trash2 class="size-4" />
                Deleted records
            </Button>
        </div>
            ...
            <Table>
                ...
                <TableBody>
                    <TableRow v-if="store.loading">
                        <TableCell :colspan="columns.length + 1" class="h-24 text-center text-muted-foreground">Loading…</TableCell>
                    </TableRow>
        ...
        <div v-if="store.pagination && total > 0" class="flex flex-wrap items-center justify-between gap-4">
