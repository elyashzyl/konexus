...
import { ArrowLeft, CalendarDays, CheckCircle2, GraduationCap, MapPin } from 'lucide-vue-next';
...
onMounted(async () => {
    try {
        enrollments.value = await portalApi.parent.enrollments(childId.value);
    } catch (error) {
